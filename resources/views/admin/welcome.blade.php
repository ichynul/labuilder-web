...
<footer class="page-footer">
    <span class="copyright">Admin copyright</span>
</footer>
@endsection
@section('script')
<!--图表插件-->
<script type="text/javascript" src="/vendor/ichynul/labuilder/lightyearadmin/js/Chart.js" charset="utf-8"></script>
